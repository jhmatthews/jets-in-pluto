...
/*! 
  ...
  \author J. Matthews (matthews@ast.cam.ac.uk)
  \date   May 18, 2017
*/
/* ///////////////////////////////////////////////////////////////////// */
...
/* ///////////////////////////////////////////////////////////////////// */
{
  double v_j, rho, v_j_cubed, interpolated_power, time_physical, beta, gmm;
  ...
  if (TIME_SERIES)
  {
    ...
    power = g_inputParam[GMM] * interpolated_power;
  ...
  {
    /* get lorentz factor */
    gmm = g_inputParam[GMM];

    beta = sqrt(1 - (1.0/gmm/gmm));
    v_j = beta;
    ...
    /* set pressure by jet mach number */
    var_array[PRS] = v_j * v_j / mach_number / mach_number / (4.0/3.0) * rho;
  }
